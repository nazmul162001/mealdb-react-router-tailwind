  ...
  return (
    <div className='text-center bg-gradient-to-r from-gray-500 via-green-500 to-gray-500'>
      <h2 className='text-3xl text-center py-5 text-violet-600 font-bold'>Food Id: {mealId} </h2>
          ...
          <img className='w-[600px] h-[350px] mx-auto rounded-2xl md:rounded-3xl p-10 md:p-0' src= {details.strMealThumb} alt="" />
        ...
        <h2 className='text-2xl py-5 px-5 text-justify'> Description: <span className='text-gray-300 font-normal text-xl'>{details.strInstructions}</span> </h2>
    </div>
  );
};
